'''
                Вступительный экзамен в Тинькофф Поколение на программу ML
                Модель "обучена" на рассказе Стивена Кинга "Долгий Джонт", а также на IX главе "Хребтов безумия" Г. Ф. Лавкрафта
'''
